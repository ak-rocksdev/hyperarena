...
class VenueReviewListScreen extends ConsumerStatefulWidget {
  final String venueId;

  const VenueReviewListScreen({super.key, required this.venueId});

  @override
  ConsumerState<VenueReviewListScreen> createState() =>
      _VenueReviewListScreenState();
}

class _VenueReviewListScreenState extends ConsumerState<VenueReviewListScreen> {
  int? _filterStar;

  @override
  Widget build(BuildContext context) {
    final reviewsAsync = ref.watch(venueReviewsProvider(widget.venueId));
    final ratingAsync = ref.watch(venueRatingProvider(widget.venueId));
      ...
      body: AsyncValueWidget(
        ...
        error: (e, _) => ErrorView(
          ...
          onRetry: () {
            ...
            ref.invalidate(venueRatingProvider(widget.venueId));
          },
        ),
        data: (reviews) {
  ...
  Widget _buildSummaryCard(VenueRatingAggregate rating) {
    return Container(
